...
export const pricingPlans: PricingPlan[] = [
  {
    ...
    features: [
      ...
      'AI test mode with 3 question types',
      'Test presets (Quick Review, Focused Study)',
      'Basic test analytics & history',
  ...
  },
  {
    ...
    features: [
      ...
      'Advanced test configurator with custom settings',
      'All test presets + Deep Assessment mode',
      'Comprehensive test analytics & performance insights',
      'Complete test history with detailed results',
      'Interactive question distribution controls',
      'Multiple file uploads per deck (up to 20 files)',
      'Multi-file bulk creation',
      'Advanced usage tracking dashboard',
      'Rich text editing',
      'Priority support',
    ],
    limits: {
